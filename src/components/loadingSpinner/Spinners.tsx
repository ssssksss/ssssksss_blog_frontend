  ...
  @keyframes animloader {
    0% {
      box-shadow: 0 calc(var(--box-size) / 2) rgba(255, 255, 255, 0),
        calc(var(--box-size) / 2) calc(var(--box-size) / 2) rgba(255, 255, 255, 0), calc(var(--box-size) / 2) var(--box-size) rgba(255, 255, 255, 0),
        0px var(--box-size) rgba(255, 255, 255, 0);
    }
    12% {
      box-shadow: 0 calc(var(--box-size) / 2) ${props => props.theme.main.secondary80},
        calc(var(--box-size) / 2) calc(var(--box-size) / 2) rgba(255, 255, 255, 0), calc(var(--box-size) / 2) var(--box-size) rgba(255, 255, 255, 0),
        0px var(--box-size) rgba(255, 255, 255, 0);
    }
    25% {
      box-shadow: 0 calc(var(--box-size) / 2) ${props => props.theme.main.secondary80},
        calc(var(--box-size) / 2) calc(var(--box-size) / 2) ${props => props.theme.main.secondary80},
        calc(var(--box-size) / 2) var(--box-size) rgba(255, 255, 255, 0), 0px var(--box-size) rgba(255, 255, 255, 0);
    }
    37% {
      box-shadow: 0 calc(var(--box-size) / 2) ${props => props.theme.main.secondary80},
        calc(var(--box-size) / 2) calc(var(--box-size) / 2) ${props => props.theme.main.secondary80},
        calc(var(--box-size) / 2) var(--box-size) ${props => props.theme.main.secondary80},
        0px var(--box-size) rgba(255, 255, 255, 0);
    }
    50% {
      box-shadow: 0 calc(var(--box-size) / 2) ${props => props.theme.main.secondary80},
    ...
    75% {
      box-shadow: 0 calc(var(--box-size) / 2) rgba(255, 255, 255, 0),
        calc(var(--box-size) / 2) calc(var(--box-size) / 2) rgba(255, 255, 255, 0),
        calc(var(--box-size) / 2) var(--box-size) ${props => props.theme.main.secondary80},
        0px var(--box-size) ${props => props.theme.main.secondary80};
    }
    87% {
