  ...
  let html = markdown
    ...
    .replace(
      ...
      (match, lang, codeBlock) => {
        ...
        return isPreview
          ? `<pre class=\"relative text-white overflow-x-scroll p-4 rounded-[1rem] bg-default-1 primary-border break-all\"><code class=\"text-[12px] whitespace-pre-wrap leading-3\">${highlightedCode}</code>
        </pre>`
