  ...
  return (
    <div className="flex justify-center items-center gap-4 px-4">
      <button
        ...
        className="primary-border-radius relative flex h-8 w-12 min-[480px]:w-16 items-center rounded-full bg-gray-300 p-1 transition-all duration-300 ease-in-out dark:bg-gray-700"
      ...
      >
        ...
        <div
          className={`bg-white-80 flex h-6 w-6 transform items-center justify-center rounded-full transition-transform duration-300 ease-in-out ${
            themeStore.isDarkMode ? "translate-x-4 min-[480px]:translate-x-8" : "translate-x-0"
          }`}
        >
          {/* 해모양과 달모양 아이콘 */}
