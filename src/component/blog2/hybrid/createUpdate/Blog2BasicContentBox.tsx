...
const Blog2BasicContentBox = (props: IBlog2BasicContentBox) => {
  ...
  return (
    <div className={"relative w-full flex flex-col rounded-[1rem] p-0"}> 
      <article className="sticky left-2 top-[4.5rem] z-10 -translate-y-2 -translate-x-2 w-fit p-1 flex default-primary-outline gap-2 opacity-80 hover:opacity-100 bg-primary-60">
        <ModalButton
          buttonClassName={"default-primary-outline px-4 font-bold h-[2.5rem] bg-white-80  hover:bg-primary-20"}
