...
interface IStackSkillContainer {

}
const StackSkillContainer = (props: IStackSkillContainer) => {
  return (
        ...
        {[
          {
            ...
            etc: [
              ...
              <div key="typescript" title="typescript">
                <svg
                  viewBox="0 0 128 128"
                  height={44}
                  width={44}
              ...
              <Image
                ...
                title="zustand"
              />,
              <div key="react-hook-form" title="React Hook Form">
                <svg
                  height={44}
                  width={44}
                  role="img"
          ...
          },
          {
            ...
            title: "Backend",
            skills: [
              <div key={"spring-boot"} title="Spring Boot">
                <svg
                  role="img"
                  height={52}
                  width={52}
            ...
            etc: [
              ...
              <div key="spring-security" title="spring-security">
                <svg
                  height={44}
                  width={44}
                  className="border-1 rounded-2xl border bg-white-80 p-1 text-default-1"
...
export default StackSkillContainer;