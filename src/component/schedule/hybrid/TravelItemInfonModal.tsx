...
const TravelItemInfonModal = (props: ITravelItemInfonModal) => {
  ...
  useEffect(() => {
    const fetchTouristInfo = async () => {
      ...
      const url = `http://apis.data.go.kr/B551011/KorService1/detailIntro1?serviceKey=${apiKey}&numOfRows=10&pageNo=1&MobileOS=ETC&MobileApp=AppTest&contentId=${props.data.contentid}&contentTypeId=${props.data.contenttypeid}&_type=json`;
