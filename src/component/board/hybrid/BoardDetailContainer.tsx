    ...
    <div className={"flex h-full w-full flex-col gap-y-2 py-4"}>
      <div className="relative min-h-[2rem] w-full default-flex">
        {userStore.nickname == props.result.data.nickname && (
          ...
          //     )
          //   }
          //   className="absolute right-0 top-1/2 -translate-y-[calc(50%+0.25rem)] px-4 py-2 default-outline hover:bg-primary-80 hover:text-white-80">
          //   수정하기
          // </button>
          <div className="absolute right-0 top-1/2 flex h-[2.5rem] -translate-y-[calc(50%+0.25rem)] gap-x-1">
            <button
              ...
              className="px-4 py-2 default-outline hover:bg-primary-80 hover:text-white-80">
              수정 하기
            </button>
            <button
      ...
      <div className="flex justify-between px-4 py-2 default-outline">
      ...
      <div className="h-auto w-full whitespace-pre-wrap break-words break-all p-4 text-[24px] font-bold default-outline default-flex">
        {props.result.data.title}
      </div>

      <div className="h-full w-full flex-grow p-4 default-outline">
